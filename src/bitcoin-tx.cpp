...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s primetalentcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  primetalentcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded primetalentcoin transaction") + "\n" +
              "  primetalentcoin-tx [options] -create [commands]   " + _("Create hex-encoded primetalentcoin transaction") + "\n" +
              "\n";
