...
#if defined(NDEBUG)
# error "primetalentcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "primetalentcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PTC additional fees, %d delta bytes\n",
