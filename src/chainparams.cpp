...
{
    const char* pszTimestamp = "BBC 29/Aug/2018 French and UK boats clash in scallop war";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1535510440, 2086346151, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0ac5eeeb8cff31c57362f86e492bd679210600d941cc27638a1a3976f8b539fa"));
        assert(genesis.hashMerkleRoot == uint256S("0x45d2147484a623c4554e1bd7b503f4dd5f72ae8dd66912d62de0352a651aaf25"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("142.93.82.154:62458", true);
        vSeeds.emplace_back("142.93.88.7:62458", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.primetalentcointools.com", true);
        vSeeds.emplace_back("seed-b.primetalentcoin.loshan.co.uk", true);
