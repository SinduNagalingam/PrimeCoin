...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/primetalentcoin-project/primetalentcoin>";
    const std::string URL_WEBSITE = "<https://primetalentcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("primetalentcoin version %s\n", FormatFullVersion());
}
